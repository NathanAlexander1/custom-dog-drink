...
// input data
export const dogBreedsListOptions = [
  {
    name: "Other",
    image:
...
export const catBreedsListOptions = [
  {
    name: "Other",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Question_Mark_1.svg/2026px-Question_Mark_1.svg.png",
...
// output data
export const cocktailDataArray = [
  {
...
// export const testCocktailIngredientsArray = API.getCocktailIngredientsList().then((data) => {
//   console.log(data)
// })

export const smoothieDataArray = [
